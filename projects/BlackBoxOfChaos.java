...
class Quadrant<SomeType>
{
	SomeType value;
	Compartment<SomeType> latch;

	Quadrant(SomeType value)
	{
		this.value = value;
	}
	...
	public void setLatch(Compartment<SomeType> c)
	{
		this.latch = c;
	}

	public Compartment<SomeType> getLatch()
	{
		return latch;
	}
...
class Compartment<SomeType>
{
	...
	Quadrant<SomeType> north;
	Quadrant<SomeType> south;
	Quadrant<SomeType> east;
	Quadrant<SomeType> west;
	...
	private BlackBoxOfChaos<SomeType> box;
	...
	Compartment(BlackBoxOfChaos<SomeType> box, int depth)
	{
		this.box = box;
		this.depth = depth;
	}
	...
	public void emplace(SomeType value)
	{
		...
		if (!this.hasSpace())
		{
			Compartment<SomeType> nextCompartment = this.findOrCreateNextCompartment();
		...
		Quadrant<SomeType> newQuadrant = new Quadrant<SomeType>(value);
	...
	private Compartment<SomeType> findOrCreateNextCompartment()
	{
		// First, try to find an adjacent compartment via the latches.
		Compartment<SomeType> foundCompartment = searchLatches();
	...
	private Compartment<SomeType> createNewCompartment()
	{
		Compartment<SomeType> newCompartment = new Compartment<SomeType>(this.box, this.depth + 1);
	...
	public void printContents()
	{
		...
		Compartment<SomeType> nextCompartment = searchLatches();
	...
	private Compartment<SomeType> searchLatches()
	{
...
public class BlackBoxOfChaos<SomeType>
{
	...
	private Compartment<SomeType> firstCompartment;
	                ...
	                int secondaryChaosAspect)
	{
		...
		this.firstCompartment = new Compartment<SomeType>(this, 0);
		this.size = 0;
